...
void Map::Build(){ //similar to drawing font
...
bool Map::IsSolid(glm::vec3 position, float *penetration_x, float *penetration_y){ //check to see if there is a tile at the position
    *penetration_x = 0;
    *penetration_y = 0;
